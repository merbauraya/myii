...
<div class="form">
 <?php $form=$this->beginWidget('CActiveForm', array(
  ...
  <div class="complex">
        ...
        <div class="grid-view">
            <table id="nRowForm" class="templateFrame" cellspacing="0" width="100%">
                ...
                <tfoot>
                    <tr>
                        <td colspan="7">
                            <div class="add">
							<?php echo CHtml::image(Yii::app()->theme->baseUrl."/img/form/add.png",'Add',array("class"=>"add")); ?>
    ...
    'htmlOptions'=>array(
		...
		'class'=>'datepick'
									...
									<?php echo CHtml::image(Yii::app()->theme->baseUrl."/img/form/delete.png",'Delete',array("class"=>"remove",'style'=>'height:100%;width:100%;')); ?>
        ...
        'style'=>'width:100px;'
						...
						echo '<td>';} ?>
							...
							echo '<td class="button-column">'; }?>
									...
									<?php 
									if ($item){
									echo CHtml::image(Yii::app()->theme->baseUrl."/img/form/delete.png",'Delete',array("class"=>"remove",'style'=>'height:100%;width:100%;')); 
